...
describe('Arrays',
    function() {
        ...
        function() {
            var c = 8;
            var cmp = function(arg1: number) {
                return arg1 === c;
            };
            var a = [1, 2, 5, 8, 10, 12];
            expect(collections.arrays.find(a, cmp)).to.deep.equal(8);
            c = 10;
            expect(collections.arrays.find(a, cmp)).to.deep.equal(10);
        });
        ...
        function() {
            ...
            var a = [1, 2, 5, 8, 10, 12];
            expect(collections.arrays.findIndex(a, cmp)).to.deep.equal(3);
            c = 12;
            expect(collections.arrays.findIndex(a, cmp)).to.deep.equal(5);
        });
        ...
        function() {
            ...
            var a = [1, 8, 8, 8, 10, 10];
            var r = [8, 8, 8];
            expect(collections.arrays.findAll(a, cmp)).to.deep.equal([8, 8, 8]);
            c = 10;
            expect(collections.arrays.findAll(a, cmp)).to.deep.equal([10, 10]);
        });
